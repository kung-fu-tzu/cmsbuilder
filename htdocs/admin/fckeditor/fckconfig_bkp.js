...
FCKConfig.ToolbarSets["Basic"] = [
	['Bold','Italic','-','OrderedList','UnorderedList','-','Link','Unlink','PasteWord','Source']
] ;

FCKConfig.ToolbarSets["CMSBuilder"] = [
	['Source','PasteText','PasteWord'],
	['Bold','Italic','Underline','StrikeThrough','RemoveFormat','TextColor','BGColor','FontSize'],
	['OrderedList','UnorderedList','-','Outdent','Indent'],
	['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull'],
