...
//## Style Names
//##
config.StyleNames  = ';Увеличить размер шрифта;Уменьшить размер шрифта;Серый цвет текста;Заголовок в тексте';
config.StyleValues = ';WYSIWYGbig;WYSIWYGsmall;WYSIWYGgrey;WYSIWYGsubHeader';

//##
//## Page Names
//##
config.PageNames  = ';О Компании;---История;---Лицензии' ;
config.PageValues = ';/about/;/about/history/;/about/lisence/' ;
...
config.ImageUploadWindowWidth	= 400 ;
config.ImageUploadWindowHeight	= 250 ;
...
// Custom Page URL
config.LinkBrowserURL = config.BasePath + "filemanager/browse/sample_php/browse.php" ;
