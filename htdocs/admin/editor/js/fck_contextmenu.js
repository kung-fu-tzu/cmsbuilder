...
LinkContextMenu[1] = new ContextMenuItem("Edit Link", "dialogLink()", TBCMD_CUSTOM) ;
LinkContextMenu[2] = new ContextMenuItem("Remove Link", DECMD_UNLINK) ;
...
TableContextMenu[12] = new ContextMenuItem("Cell Properties", "dialogTableCell()", TBCMD_CUSTOM) ;
TableContextMenu[13] = new ContextMenuItem("Table Properties", "dialogTable(true)", TBCMD_CUSTOM) ;
...
function showContextMenu()
{
	...
	if (sTag == "TABLE")
	{
		...
		ContextMenu[index++] = new ContextMenuItem("Table Properties", "dialogTable()", TBCMD_CUSTOM) ;
	}
	else if (sTag == "IMG")
	{
		ContextMenu[index++] = new ContextMenuSeparator() ;
		ContextMenu[index++] = new ContextMenuItem("Image Properties", "dialogImage()", TBCMD_CUSTOM) ;
	}
