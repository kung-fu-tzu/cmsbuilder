...
sub site_pagesline
{
	...
	print '<div class="pagesline"><span class="text">Ñòğàíèöû:</span>';
...
sub site_preview
{
	...
	print '<h4>',$o->{'name'},'</h4><p>Ïğåäâàğèòåëüíûé âûâîä (site_preview) äëÿ êëàññà "',ref($o),'" íå îïğåäåë¸í.</p>';
}
...
sub site_mainpreview
{
	...
	print '<h4>',$o->{'name'},'</h4><p>Âûâîä íà ãëàâíîé (site_index) äëÿ êëàññà "',ref($o),'" íå îïğåäåë¸í.</p>';
}
