...
sub _props
{
	...
	'ClassList'		=> { 'type' => 'ClassList', 'class' => 'User', 'name' => 'Перечень объектов (User)' },
	'ClassList1'	=> { 'type' => 'ClassList', 'class' => 'User', 'isnull' => 1, 'name' => 'Перечень объектов (User) Пустой' },
	'ClassList2'	=> { 'type' => 'ClassList', 'class' => 'User', 'once' => 1, 'name' => 'Перечень объектов (User) Однократно' },
