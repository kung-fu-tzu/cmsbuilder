...
sub mod_load
{
	...
	push @modControlPanel::ISA,'modCPanelBackup::ModBackup';
}
...
package modCPanelBackup::ModBackup;
use strict qw(subs vars);
use utf8;

our @ISA = qw(modFileManager::Object); #CMSBuilder::Admin::Simple
