...
sub mod_load
{
	unshift @CMSBuilder::DBI::Object::ISA,'modAccess::ObjectHook';
	
	cmsb_event_reg('admin_view_additional',\&modAccess::ObjectHook::admin_additional);
}
