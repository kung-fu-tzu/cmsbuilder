...
package CMSBuilder::Admin::Simple;
use strict qw(subs vars);
use utf8;

our @ISA = qw(CMSBuilder::DBI::Object::ONoBase CMSBuilder::DBI::Object CMSBuilder::Admin::RootElement);
...
sub smodule_make_tree
{
	...
	if($obj->{'-obj'})
	{
		...
		$ret = {-name => $to->admin_name(), -id => $o->myurl().'_'.$to->myurl()} if $to;
	}
	elsif($obj->{'-sub'})
	{
...
sub admin_view_left
{
	...
	if($o->isa('CMSBuilder::Admin::Tree'))
	{
		$norooticon = 1;
